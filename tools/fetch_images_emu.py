#!/usr/bin/env python3
"""Baixa as capas de emulacao (SNES/GBA/PS1) do LaunchBox e grava em images/ como WebP.
...
def main():
    ...
    with open(os.path.join(ROOT, "data", "emu.json"), encoding="utf-8") as f:
        jogos = json.load(f)
    itens = [(g["id"], g["lbFile"]) for g in jogos if g.get("lbFile")]
